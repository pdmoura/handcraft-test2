      ...
      <div className="container-app py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-10 text-center sm:text-left">
          ...
          <div className="sm:col-span-2 lg:col-span-3 flex flex-col items-center sm:items-start">
            <Link href="/" className="inline-flex flex-col items-center sm:items-start gap-2 mb-4 hover:opacity-90 transition-opacity">
              <Image src="/logo-idea-1.png" alt="Handcrafted Haven" width={120} height={40} className="object-contain shrink-0 rounded-xl h-10 w-auto" />
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex justify-center sm:justify-start gap-3">
              <a href="#" className="flex items-center justify-center w-10 h-10 border border-white/20 rounded-xl text-white/80 hover:bg-cta hover:border-cta hover:text-white transition-all" aria-label="Instagram">
              ...
              <a href="#" className="flex items-center justify-center w-10 h-10 border border-white/20 rounded-xl text-white/80 hover:bg-cta hover:border-cta hover:text-white transition-all" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                </svg>
              </a>
              <a href="#" className="flex items-center justify-center w-10 h-10 border border-white/20 rounded-xl text-white/80 hover:bg-cta hover:border-cta hover:text-white transition-all" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
