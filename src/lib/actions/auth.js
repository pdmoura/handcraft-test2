...
export async function updateProfileAction(data) {
  try {
    ...
    // If role changed or name changed, let's update token or revalidate
    // Since Next.js token is stored in cookie, if role changed to seller, we should re-sign token
